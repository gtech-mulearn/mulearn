      ...
      </div>
      {
        ...
        <div className={`flex flex-wrap gap-5 justify-center min-w-screen`}>
          ...
          <>
            ...
            <div
              className={`fixed w-screen h-screen top-0 left-0 right-0 bottom-0 z-[100] bg-black/50  text-white lg:text-3xl ${imageView ? "lg:block md:block " : "hidden"
                } select-none`}
            >
              <div className="flex justify-between items-center h-screen">
                ...
                <div
                  className={`bg-white/10 h-full pr-5 justify-center flex items-center text-white/50 hover:text-orange-400 ${currentIndex > 0 ? "" : "opacity-0"
                    }`}
                  onClick={() => {
                    if (currentIndex > 0) {
...
=======
          {/*Forward switch */}
>>>>>>> 58bd62ded9145829e61fb000edbfcc256c1129c1
