...
const BlogsLandingAmirtha = () => {
    return (
        <>
            <BlogTemplate
                img="/assets/blogs/amritha.webp"
                paragraph={["A graduate in Electrical and Electronics Engineering from",
                    ...
                    "co-campus ambassadors from the same college.", <br />, <br />,
                    ...
                    "get them onboarded on to the 𝝁Learn Discord platform.", <br />, <br />,
                    ...
                    "kick-start of 𝝁Learn 2.0.", <br />, <br />,
                    ...
                    "every individual who struggles in their professional journey.", <br />, <br />]}
                />
        </>
    )
}

export default BlogsLandingAmirtha