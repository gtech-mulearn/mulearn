export const entrepreneurship = {
  ...
  communityPartners: [
    {
      name: "Udhyam Foundation",
      image: "/assets/IG/Entrepreneurship/Community Partners/Udhyam Logo.png",
    },
  ],

  prerequisites: [
    "Essential skills for entrepreneurship: problem-solving, adaptability, and strategic thinking.",
    "A quiz covering key entrepreneurship concepts to test understanding and sharpen essential skills.",
  ],
