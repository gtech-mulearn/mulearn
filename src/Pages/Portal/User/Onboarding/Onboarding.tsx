                  ...
                  <div className={styles.input_container}>
                    <div className={styles.grouped_inputs}>
                      <div style={role[0].title == "Student" ? { width: "78%" } : { width: "100%" }} className={styles.input_container}>
                        ...
                        <ReactSelect
                          value={collegeOptions.find((college) => college.value === orgnization)}
                          onChange={(option) => option && setOrgnization(option.value)}
              ...
              onClick={(e) => {
                ...
                if (firstName != '' && email != '' && phone != 0 && role[0]['id'] != '' && orgnization != '' && areaOfInterest.length > 0) {
                  ...
                  if (firstName == '') {
                    ...
                    if (role[0].title == "Student" || role[0].title == "Enabler") {
                      if (orgnization == '') {
                        let college_field: HTMLInputElement = document.getElementById('college_field') as HTMLInputElement;
                        college_field.style.border = "1px solid red";
                      } if (dept == '') {
