        ...
        <ol>
          <li>
            ...
            <ol style={{ listStyleType: "lower-roman", paddingLeft: "10px" }}>
              ...
              <li>
                <strong>Intellectual Property Rights</strong> means and includes
              ...
              <li>
                <strong>Services</strong> means the services more particularly
                described in Clause 2 of these Terms.
              </li>
              <li>
                <strong>Training or Training Material(s)</strong> means the
              ...
              <li>
                <strong>Website</strong> means https://mulearn.org/ owned and
                maintained by μLearn.
              </li>
              <li>
                <strong>You or you or your or yourself</strong> refers to the
