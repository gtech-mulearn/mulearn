        ...
        <>
            <div className={styles.dropdownPerPage}>
                ...
                <div className={styles.dropdownContentPerPage}>
                    <button onClick={handleBtn} value={5}>
                        5
                    </button>
                    <button onClick={handleBtn} value={10}>
                        10
                    </button>
                    <button onClick={handleBtn} value={20}>
                        20
                    </button>
                    <button onClick={handleBtn} value={50}>
                        50
                    </button>
                    <button onClick={handleBtn} value={100}>
                        100
                    </button>
                </div>
            </div>
