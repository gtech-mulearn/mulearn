...
export const FormTabDates = () => {
    return (
        <>
            ...
            <FormikTextInputWhite
                label={
                    <span className="requiredLabel">Registration End Date</span>
                }
            ...
            <FormikTextInputWhite
                label={
                    <span className="requiredLabel">Hackathon Start Date</span>
                }
                name="eventStart"
                className={styles.placeholder}
                type="date"
            ...
            <FormikTextInputWhite
                label={
                    <span className="requiredLabel">Hackathon End Date</span>
                }
                name="eventEnd"
                className={styles.placeholder}
                type="date"
