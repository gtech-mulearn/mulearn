...
export default function LearningCircleLanding() {
    ...
    const [interestOptions, setInterestOptions] =
        useState<Option[]>(INITIAL_INTERESTS);
    const [selectedInterest, setSelectedInterest] = useState<Option | null>(
        INITIAL_INTERESTS[0]
    );
        ...
        <main className={styles.main}>
            <div className={styles.container}>
                <div
                    ...
                    data-tour="learning-circle-header"
                >
                    <div className={styles.headerTextContainer}>
                        <h1 className={styles.headerTitle}>Learning Circles</h1>
                        <p className={styles.headerDescription}>
                            Join collaborative learning groups focused on
                            specific topics. Learn together, share knowledge,
                            and track your progress in a supportive community.
                        </p>
                    </div>
                        ...
                        >
                            <DialogTrigger asChild>
                                <Button
                                    ...
                                    data-tour="create-circle-button"
                                >
                ...
                {/* Add Learning Circle specific tour button */}
                <div
                    style={{ position: "absolute", top: "10px", right: "20px" }}
                >
                    <TourButton
                        tourType="learningCircle"
                        buttonText="Learning Circle Tour"
                    />
                </div>
              ...
              >
                ...
                <div
                    ...
                    data-tour="learning-circle-list"
                >
                ...
                {filteredCircles.length === 0 && !isLoading && (
                    <div className={styles.noResultsContainer}>
                        ...
                        <p className={styles.noResultsDescription}>
                            Try adjusting your search or create a new learning
                            circle
                        </p>
                    </div>
                )}
