// AchievementDefinitions.tsx - Table-based achievement management
        ...
        try {
            ...
            if (achievements) {
                const transformedData = achievements.map(achievement => ({
                    ...
                    level_based: achievement.level_based ?? false,
    ...
    const handleDelete = async (id: string | undefined) => {
        if (id) {
            try {
                ...
                navigate("/dashboard/management/manage-achievements/definitions");
            } catch (error) {
