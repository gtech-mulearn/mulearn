...
function ManageRoles() {
    ...
    const [currModal, setCurrModal] = useState<null | "create" | "edit" | "users">(null);
    const [roles,setRoles] = useState<any>()
    const icons = {
        user:<div className={modalStyles.TickIcon}>
            <AiOutlineUser
                width="20"
                height="20"
            /> 
        </div>,
        tick:<div className={modalStyles.TickIcon}>
        <svg
            width="20"
            height="20"
            viewBox="0 0 24 24"
        ...
        cross:<div className={modalStyles.CrossIcon}>
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
