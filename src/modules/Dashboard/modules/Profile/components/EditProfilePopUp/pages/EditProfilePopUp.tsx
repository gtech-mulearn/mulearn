...
import { capitalizeFirstLetter, toReactSelectOptions } from "../../../../../utils/common";
...
const EditProfilePopUp = (props: Props) => {
    ...
    const filteredCommunityOptions = toReactSelectOptions(communityAPI.filter(value => communityIds?.includes(value.id)))
    const propsList2 = {
    ...
    const communityProps = {
        ...
        options: toReactSelectOptions(communityAPI)
    }
