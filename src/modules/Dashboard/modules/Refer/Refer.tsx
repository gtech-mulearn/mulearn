...
const Refer = () => {
    ...
    return (
        <>
      { open && <Modal icon="send" header="Invite" paragraph="Send a invite link to a email" onClose={()=> setOpen(false)}>
        <InviteFormModel onClose={()=>setOpen(false)} />
                ...
                <div className={styles.headContent}>
                    ...
                    <div className={styles.learningCircleLandingPageDesc}>
                        ...
                        <b style={{ fontWeight: "600", width: "80%" }}>
                            An amazing opportunity to invest a brief moment in exploring fresh horizons alongside a 
            ...
            <Table rows={data} columnOrder={columnOrder} page={currentPage} perPage={perPage} >
                <THead
