...
function ZonalDashboard() {
    ...
    useEffect(() => {
        ...
        getzonaldashboard(activeTab,setData, 1, perPage, setTotalPages, "", "");
    }, []);
    ...
    const handleSearch = (search: string) => {
        setCurrentPage(1);
        getzonaldashboard(activeTab,setData, 1, perPage, setTotalPages, search, "");
    };

    const handlePerPageNumber = (selectedValue: number) => {
        setCurrentPage(1);
        setPerPage(selectedValue);
        getzonaldashboard(activeTab,setData, 1, selectedValue, setTotalPages, "", "");
    };
    ...
    const handleIconClick = (column: string) => {
		if(sort === column){
			setSort(`-${column}`);
			getzonaldashboard(activeTab,setData, 1, perPage, setTotalPages, "", sort);
		}
		else {
			setSort(column);
			getzonaldashboard(activeTab,setData, 1, perPage, setTotalPages, "", sort);
