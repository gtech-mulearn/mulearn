        ...
        <div className={styles.features}>
            <div className={styles.featureContainer}>
                <Feature
                    ...
                    icon={<img src={cdnUrl("src/modules/Public/KKEM/assets/feat1.svg")} alt="Personalized Learning" />}
                />
                <Feature
                    ...
                    icon={<img src={cdnUrl("src/modules/Public/KKEM/assets/feat2.svg")} alt="Skill Development" />}
                />
                <Feature
                    ...
                    icon={
                        <img src={cdnUrl("src/modules/Public/KKEM/assets/feat3.svg")} alt="Industry-Relevant Curriculum" />
                    }
                />
            </div>
            <div className={styles.featuresImage}>
                <img src={cdnUrl("src/modules/Public/KKEM/assets/Train.webp")} alt="Skill Express Features" />
            </div>
        </div>
    );
}
