    ...
    <div id="Onboarding" className={styles.onboarding}>
       <h1><span className={styles.onboardingHeading}>Onboarding </span>Process</h1>
        <div className={styles.onboardingList}>
            <h1><span>1</span><img src={Mu} alt="" /><a href="https://app.mulearn.org/"target="_blank" rel="noreferrer">Create µLearn Profile</a></h1>
        ...
        <div className={styles.onboardingList}>
            <h1><span>2</span><img src={Discord} alt="" /><a href="https://discord.gg/3v5GvJ8" target="_blank" rel="noreferrer">Welcome to Discord</a></h1>
        ...
        <div className={styles.onboardingList}>
            <h1><span>3</span><img src={Bulb} alt="" /><a href="https://app.mulearn.org/" target="_blank" rel="noreferrer">Add Interest Groups</a></h1>
